        ...
        <div className="flex flex-col gap-8 animate-in fade-in duration-500 w-full">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pb-6 border-b border-gray-200">
                <div className="min-w-0">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-black">Kode Referral Agen</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <motion.div
                    ...
                    className="lg:col-span-2 relative bg-white border border-gray-200 rounded-lg p-8 sm:p-10 shadow-sm"
                >
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <p className="text-black font-bold text-lg">Kode Eksklusif Anda</p>
                            <p className="text-gray-500 text-sm">Gunakan kode ini saat pendaftaran</p>
                        </div>
                    </div>

                    <div className="flex flex-col sm:flex-row items-center gap-4">
                        <div className="flex-1 w-full bg-gray-50 border border-gray-200 rounded-md px-6 py-5 flex items-center justify-center sm:justify-start">
                            <span className={cn("font-bold tracking-[0.2em] uppercase", data?.referral_code ? "text-4xl text-black" : "text-xl text-gray-400")}>
                        ...
                        <div className="flex sm:flex-col gap-3 w-full sm:w-auto">
                            {!data?.referral_code ? (
                                <Button
                                    ...
                                    disabled={generating}
                                    className="w-full bg-black text-white hover:bg-black gap-2 rounded-md h-14 px-8 shadow-sm transition-all"
                                >
                                ...
                                <>
                                    <Button
                                        onClick={copyCode}
                                        className="flex-1 sm:flex-none bg-black text-white hover:bg-black gap-2 rounded-md h-14 px-8 shadow-sm transition-all"
                                    >
                                    ...
                                    <Button
                                        onClick={shareCode}
                                        variant="outline"
                                        className="flex-1 sm:flex-none border-gray-200 text-gray-700 hover:bg-gray-50 gap-2 rounded-md h-14 px-8 transition-all"
                                    >
                ...
                <motion.div
                    ...
                    className="bg-white border border-gray-200 rounded-lg p-8 sm:p-10 shadow-sm flex flex-col justify-center"
                >
                    <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                {[
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-lg border border-gray-200 p-8 shadow-sm hover:shadow-md transition-all duration-300"
                    >
                        <div className="h-10 w-10 rounded-md bg-gray-50 flex items-center justify-center mb-4 border border-gray-200">
                            <s.icon className="h-4 w-4 text-gray-600" />
                        </div>
                        <p className="text-3xl font-bold tabular-nums text-black tracking-tight mb-1">{s.value}</p>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8 sm:p-10 shadow-sm">
                <h2 className="text-xl font-bold text-black mb-8">Cara Kerja Program Referral</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        >
                            <div className="h-12 w-12 rounded-md bg-black text-white font-bold flex items-center justify-center text-lg shadow-sm">
                                {step.step}
                            </div>
                            <div>
            ...
            {(data?.recent_referrals?.length ?? 0) > 0 && (
                <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                    <div className="px-8 py-6 border-b border-gray-50 bg-white">
                        <h2 className="text-lg font-bold text-black">Riwayat Referral Terbaru</h2>
                    ...
                    <div className="divide-y divide-gray-50">
                        {data!.recent_referrals.map((ref, i) => (
                            <motion.div
                                ...
                                className="flex flex-col sm:flex-row sm:items-center justify-between p-6 sm:px-8 hover:bg-white transition-colors gap-4"
                            >
                                <div className="flex items-center gap-4">
                                    <div className="h-12 w-12 rounded-md bg-white border border-gray-200 shadow-sm flex items-center justify-center shrink-0">
                                        <Users className="h-5 w-5 text-gray-400" />
                                    </div>
                                    <div className="flex flex-col">
                                        <p className="text-[15px] font-bold text-black">{ref.referred_email}</p>
                                ...
                                <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center w-full sm:w-auto mt-2 sm:mt-0 pt-4 sm:pt-0 border-t sm:border-t-0 border-gray-200">
                                    <p className={cn(
