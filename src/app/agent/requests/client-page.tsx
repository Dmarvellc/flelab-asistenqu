        ...
        <div className="flex flex-col gap-8 animate-in fade-in duration-500 w-full">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pb-6 border-b border-gray-200">
                <div className="min-w-0">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-black">Permintaan Data Pasien</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <div key={s.label} className="bg-white rounded-lg border border-gray-200 p-8 shadow-sm hover:shadow-lg transition-all duration-300" style={{ animationDelay: `${i * 100}ms` }}>
                        <p className="text-4xl font-bold tabular-nums tracking-tight text-black mb-2">{s.value}</p>
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm flex flex-col">
                {/* Search + Filters */}
                <div className="flex flex-col lg:flex-row lg:items-center justify-between p-4 sm:p-8 border-b border-gray-50 bg-white gap-6">
                    <div className="relative w-full lg:max-w-md">
                        <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                        <Input
                            type="search"
                            placeholder="Cari nama atau NIK..."
                            className="pl-12 h-12 bg-white border-gray-200 text-[15px] rounded-md focus:bg-white focus:border-gray-300 focus:ring-4 focus:ring-gray-900/5 transition-all shadow-sm w-full"
                            value={search}
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        {filterTabs.map(tab => (
                            <button
                                ...
                                className={cn(
                                    "text-[14px] font-semibold px-5 py-2.5 rounded-md transition-all duration-200 flex items-center gap-2 shadow-sm border",
                ...
                <div className="p-4 sm:p-8 bg-white min-h-[300px]">
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-24 text-center text-gray-500 bg-white rounded-[24px] border border-gray-200/50 m-4">
                            ...
                            <p className="text-xl font-bold text-black mb-2">Tidak ada permintaan</p>
                                        ...
                                        <div className="flex flex-col gap-3 flex-1 min-w-0 pr-6">
                                            <div className="flex items-center justify-between lg:justify-start gap-4 flex-wrap w-full">
                                                <div className="flex flex-col">
                                                    <h3 className="font-bold text-black text-lg">{req.person_name}</h3>
                                                ...
                                                <div className="flex items-center gap-2 text-[13px] font-bold px-3 py-1.5 rounded-lg border border-gray-200 bg-gray-50 shadow-sm w-max lg:ml-auto">
                                                    ...
                                                    <span className={cn(
                                                        req.status === 'PENDING' ? "text-black" :
                                                            req.status === 'APPROVED' || req.status === 'COMPLETED' ? "text-black" :
                                                                "text-gray-600"
                                                    )}>
                                                        {cfg.label}
                                                    </span>
                                            ...
                                            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[14px] text-gray-500 mt-2">
                                                ...
                                                {req.additional_data_request && req.additional_data_request.trim() !== '' && (
                                                    <span className="truncate max-w-md text-gray-600 font-medium bg-gray-50 px-3 py-1 rounded-md border border-gray-200">
